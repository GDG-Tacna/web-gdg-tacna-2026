...
export function Agenda() {
  ...
  return (
    <section id="agenda" className="relative scroll-mt-28 py-24 sm:py-32">
      <div className="shell">
        <SectionHeading
          eyebrow="Agenda"
          title="Un día completo de aprendizaje, código y comunidad"
          description="Charlas de 40 minutos, un workshop práctico y espacios de networking. Filtra por el track que más te interese."
        />
        ...
        <Reveal>
          <p className="mt-10 text-center text-[12px] text-faint">
            El horario es referencial y puede sufrir cambios hasta la fecha del
            evento.
          </p>
        </Reveal>
      </div>
